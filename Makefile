...
PROJECT_REPO := github.com/fcosta999/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION := 1.49.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-openstack
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-openstack_v1.49.0
export TERRAFORM_DOCS_PATH := website/docs/d
